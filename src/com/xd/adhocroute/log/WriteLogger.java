...
public class WriteLogger {
    ...
    private static final String TAG = "AdhocRoute";

    private static String MYLOG_PATH_SDCARD_DIR = "/AdhocRoutelog/";// 日志文件在sdcard中的路径
    private static String LOG_NAME = "AdhocRoute.txt";// 本类输出的日志文件名称
